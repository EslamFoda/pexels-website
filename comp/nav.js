...
import { Avatar, Button, Popover, Stack, TextField } from "@mui/material";
  ...
  return (
    <NavContainer>
      ...
      <ElevationScroll {...props}>
        <AppBar
          className="bar"
          style={{ background: trigger ? " #232a34" : "transparent" }}
        >
          <Container maxWidth="xl">
            ...
            >
              ...
              <Stack
                spacing={2}
                sx={{ width: "100%", display: trigger ? "flex" : "none" }}
              >
                <Autocomplete
                  size="small"
                  freeSolo
              ...
              <Stack direction="row" alignItems="center" spacing={4}>
                ...
                <Button
                  style={{ boxShadow: "unset", backgroundColor: "#05a081" }}
                  variant="contained"
                >
                  Upload
                </Button>
